...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date: Attribute.Date;
    description: Attribute.String;
    type: Attribute.Enumeration<['event', 'competition']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiScheduleSchedule extends Schema.CollectionType {
  ...
  attributes: {
    ...
    lessons: Attribute.Component<'lesson.lesson', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSubInfoSubInfo extends Schema.CollectionType {
  collectionName: 'sub_infos';
  info: {
    singularName: 'sub-info';
    pluralName: 'sub-infos';
    displayName: 'SubInfo';
  };
  options: {
    draftAndPublish: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::sub-info.sub-info': ApiSubInfoSubInfo;
    }
  }
}
